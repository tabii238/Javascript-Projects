...
const Calculator = {
    ...
    Display_Value: '0',
    // this will hold the first oeprand for any expressions, we set it to null for now
    First_Operand: null,
...
function Input_Digit(digit) {
    ...
    // we are checking ot see if Wait_Second_Operand is true and set
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        // here we add a fixed amount of numbersafter the decimal
