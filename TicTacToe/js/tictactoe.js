...
// This functions parses the selectedSquares array to search for win conditions
...
function checkWinConditions() {
    ...
    // squares are selected the code executes
        ...
        audio('./media/myTieSound.mp3');
        // This function sets a .3 second timer before the resetGame is called.
        setTimeout(function () { resetGame(); }, 1000);
    }


    // This function chekcs if an array includes 3 strings. It is used to check for each win.
...
function disableClick() {
    ...
    //This makes our body unclickalbe again after 1 second.
...
// This line accesses our html canvas element.
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            // if we've reaced the end points.
    ...
    // This function clears canvas after wine line is drawn.
    function clear() {
...
// This function resets the game in teh event of a tie or win
function resetGame() {
